...
#define PARAM_ITUR_BT6015_NR0	0


#define NUMBER_OF_USER_PARAMS 1

class PluginLuma Matrix : public IPlugin	
{
public:
	...
	int GetUIParameters (UIParameters* pParameters)
	{
		...
		AddParameter( PARAM_ITUR_BT6015_NR0 ,"ITU-R BT.601-5|ITU-R BT.709|PAL ITU/EBU 3213|SMPTE 240M-1995|KODAK Grey|Sony Triton Sim|HSI|HSV|MIN|Ac1c2|Erik Reinhard LAB|Hunter Lab|CIE Lab ala GIMP|HSP|Andy Special", 0, 0, 14, TYPE_ONEOFMANY, 0);
	...
	virtual void Process_Data (BYTE* pBGRA_out,BYTE* pBGRA_in, int nWidth, int nHeight, UIParameters* pParameters)
	{
		...
		//List of Parameters
		int nITUR_BT6015ITUR = (int)GetValue(PARAM_ITUR_BT6015_NR0);
